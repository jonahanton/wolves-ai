...
ANTHROPIC_PRICES: dict[str, TokenPrices] = {
    ...
    "claude-sonnet-5": TokenPrices(input=3.00, output=15.00, cache_write=3.75, cache_read=0.30),
    "claude-haiku-4-5": TokenPrices(input=1.00, output=5.00, cache_write=1.25, cache_read=0.10),
}

_DEFAULT = ANTHROPIC_PRICES["claude-sonnet-5"]


def _normalise(model: str) -> str:
    """Map a dated model id (e.g. ``claude-haiku-4-5-20251001``) to a price key.
