...
SPEC = ToolSpec(
    ...
    description=(
        ...
        "a resubmission or firing the steelman pause. The published_preview block is the final title surface "
        "after any calibration governor; quote those numbers in prose. Use it to triage a draft before "
        "submit_forecast."
    ),
