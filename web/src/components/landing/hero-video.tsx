  ...
  return (
    <section className="relative isolate overflow-hidden">
      <div aria-hidden className="pointer-events-none absolute inset-0 -z-10">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(105%_85%_at_50%_42%,oklch(0.175_0.014_65)_40%,oklch(0.175_0.014_65/0.84)_64%,oklch(0.175_0.014_65/0.55)_84%,oklch(0.175_0.014_65/0.32)_100%)]" />
      </div>
